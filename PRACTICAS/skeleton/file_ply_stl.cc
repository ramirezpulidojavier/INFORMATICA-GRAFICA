...
//******************************************************************************
//Lee un fichero ply que contiene todos los triangulos y vertices de una figura Ply, los carga en dos vectores y se pasan como es debido a Vertices
// y Triangulos
//******************************************************************************
...
//******************************************************************************
// Lee un fichero ply que no te dice la cantidad de triangulo ni vertices como los otros, sino
// que te da un perfil, un eje y un numero de giros
//******************************************************************************

void _file_ply::read_perfil(vector<float> &Coordinates, int &eje, int &giros)
{
  string Token;
  istringstream Line_stream;
  unsigned int Pos;
        ...
        if(Token=="vertex"){
          ...
          if(Token=="face"){
            do{
              ...
              if(Token == "propiedades"){ //para tener el eje y los giros
                  get_token(Line_stream, Token);
                  eje = stoi(Token);
                  get_token(Line_stream, Token);
                  giros = stoi(Token);
